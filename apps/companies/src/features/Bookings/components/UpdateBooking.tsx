import { useGetTripsList, useGetUsersList, useUpdateBooking } from "@/features";
...
import { Booking, BookingPayload, Trip, User } from "utilities";
...
export function UpdateBooking({
  ...
  const updateBookingsMutation = useUpdateBooking(booking.pk);

  const bookingForm = useForm<BookingPayload>({
    initialValues: {
      trip: booking.trip.pk,
      passenger_count: booking.passenger_count,
      user: booking.user.pk,
    },
            ...
            <form onSubmit={bookingForm.onSubmit(handleSubmit)}>
              ...
              >
                ...
                <Button
                  ...
                  type="submit"
                  loading={updateBookingsMutation.isLoading}
                  color="error"
                  className="bg-primary-orange-100 rounded-[10px] h-10 normal-case"
                  variant="contained"
                >
