...
import { useUpdateVehicle } from "../services";
...
export function UpdateVehicles({
  ...
  const updateVehicleMutation = useUpdateVehicle(vehicle.pk);
  ...
  const vehicleForm = useForm<Vehicle>({
    initialValues: {
      ...
      options: {
        air_conditioning: vehicle.options.air_conditioning,
        tv: vehicle.options.tv,
        wifi: vehicle.options.wifi,
        usb: vehicle.options.usb,
      },
